package com.phonegap.ebike.fragment.myfragment;
...
public class MyFragment extends BaseFragment {
    private ImageButton myfragmentExt;
    private View v;
    private Context context;
    private Activity activity;
    private TextView phoneTv, termIdTv, speedTv, nickNameTv, emailTv, userNameTv,versionTv;
    ...
    private void initView() {
        versionTv = (TextView) v.findViewById(R.id.myfragment_version);
        myfragmentExt = (ImageButton) v.findViewById(R.id.myfragment_ext);
