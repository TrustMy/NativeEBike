...
import com.phonegap.ebike.activity.carhistroy.vehicletrajectory.CarHistroyRecyclerViewNowAdapter;
...
import com.phonegap.ebike.tool.trustinterface.EndlessRecyclerOnScrollListener;
...
public class CarHistroyActivity extends BaseActivity {
    ...
    private RecyclerView recyclerView ,  activityCarHistroyNowRecyclerview;;
    ...
    private void initView() {
        ...
        activityCarHistroyNowLayout = (PercentLinearLayout) findViewById(R.id.activity_car_histroy_now_layout);
        activityCarHistroyNewUpdate = (ImageView) findViewById(R.id.activity_car_histroy_new_update);
        activityCarHistroyNowTime = (TextView) findViewById(R.id.activity_car_histroy_now_time);
        activityCarHistroyLoadDateLayou = (LinearLayout) findViewById(R.id.activity_car_histroy_load_date_layou);
        ...
        activityCarHistroyNowRecyclerview = (RecyclerView) findViewById(R.id.activity_car_histroy_now_recyclerview);
